...
const typedHome = new Typed('#Home-typed', {
    strings: [ 'Full Stack Web Developer', 'Data Analyst'],
    typeSpeed: 60,
    backspeed: 30,
    backdelay : 2000,
    loop : true,
...
const sendEmail = async (e)=>{
   ...
   try{
      await emailjs.sendForm('service_humi8dm', 'template_gvt67lm', '#contact-form', 'X0kRn2WxGaPpaH7nP')
      ...
      setTimeout(() =>contactMessage.textContact = '', 5000)
   }
}
